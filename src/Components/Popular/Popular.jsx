...
const Popular = () => {
  return (
    <div className='flex flex-col items-center popular gap-[10px] lg:h-[90vh] mb-20 '>
      <h1 className='text-[#171717] lg:text-5xl text-2xl font-semibold md:text-4xl '>POPULAR ITEMS</h1>
